...
if __name__ == '__main__':
    ...
    parser.add_argument('--training_dataset_uri', type=str, default='azureml://locations/eastus/workspaces/{}/data/bike-rentals/versions/1',     help='Default training dataset uri is populated from the parent run')
